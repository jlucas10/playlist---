/*
TODO for whole file for fixing function parameters

TODO in mergedicts() for comparison operators
TODO in insert_in_order() for adding function to get title from Creation and fix text output
TODO in linearSearch() for adding function to get title from Creation and logic for string comparison
//TODO in print() and reversePrint() for adding function to get title from Creation
*/
...
Node *LinkedList::linearSearch(const Creation &c, string &prevC, string &nextC)
//TODOOOOOOOOOOOOOOOOOOOOOOOOOOOO
{
    Node *current = head;
    //TODO fix logic to make this prevC the title of the previous Creation
    prevC = "";
    nextC = "";

    while (current != nullptr)
    {
        if (current->getCreation() == c)
        {
            // Fill previous and next words
            if (current->getPrev())
            {
                prevC = current->getPrev()->getCreation();
            }
            if (current->getNext())
            {
                nextC = current->getNext()->getCreation();
            }
            return current; // Return the node where the word is found
        }
        else if (current->getCreation() < c)
        {
            prevC = current->getCreation();
        }
        else if (current->getCreation() > c && nextC.empty())
        {
            nextC = current->getCreation();
        }
        current = current->getNext();
    }
...
//TODO need to fix logic and function parameters for Creations and their titles
{
...
//TODOOOOOOOOOOOOOOOOOOOOOO
{
    ...
    while (current != nullptr && current->getCreation() < newWord)
    {
        prevNode = current;
        current = current->getNext();
    }
    ...
    if (current != nullptr && current->getCreation() == newWord)
    {
        // Word already exists
        ...
        if (current->getPrev())
        {
            cout << " The previous word would be '" << current->getPrev()->getCreation() << "'." << endl;
        }
        else
        {
        ...
        if (current->getNext())
        {
            cout << " The next word would be '" << current->getNext()->getCreation() << "'." << endl;
        }
        else
        {
